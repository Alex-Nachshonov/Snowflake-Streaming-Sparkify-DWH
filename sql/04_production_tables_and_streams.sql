...
--Select
SELECT *
FROM UDACITY.STAGING.DIM_USERS_STREAM;
SELECT *
FROM UDACITY.STAGING.DIM_SONGS_STREAM;
SELECT *
FROM UDACITY.STAGING.DIM_ARTISTS_STREAM;
SELECT *
FROM UDACITY.STAGING.DIM_TIME_STREAM;
...
SELECT *
FROM UDACITY.STAGING.SD_SONGPLAYS_STREAM;
SELECT *
FROM UDACITY.STAGING.LD_SONGPLAYS_STREAM;